...
public class MainActivity extends ActionBarActivity implements DrawerListFragmentListener, FbLogInFragmentListener, 
		DiscoverFragmentListener, EventListener, ArtistListener, VenueListener, FragmentLoadedFromBackstackListener, 
		MapListener, ConnectAccountsFragmentListener, SearchView.OnQueryTextListener, ChangeLocationFragmentListener {
	...
	private void addDrawerListFragment() {
        ...
        fragmentTransaction.add(R.id.rootNavigationDrawer, drawerListFragment, DRAWER_LIST_FRAGMENT_TAG);
