...
public class CatTitlesAdapterTab extends Adapter<CatTitlesAdapterTab.ViewHolder> {
	...
	public CatTitlesAdapterTab(List<Category> evtCategories, DiscoverFragmentTab discoverFragmentTab) {
	...
	@Override
	public void onBindViewHolder(CatTitlesAdapterTab.ViewHolder holder, final int pos) {
	...
	public void setSelectedPos(int selectedPos) {
		...
		if (this.selectedPos != selectedPos) {
			...
			notifyItemChanged(this.selectedPos);
			discoverFragmentTab.onCatChanged(this.selectedPos, selectedCatId);
		}
	}
