...
public class FollowingFragment extends ListFragmentLoadableFromBackStack {
			...
			if (artistList.get(position) == null) {
				...
				convertView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						((ArtistListener)FragmentUtil.getActivity(FollowingFragment.this)).onArtistSelected(artist);
					}
				});
			}
