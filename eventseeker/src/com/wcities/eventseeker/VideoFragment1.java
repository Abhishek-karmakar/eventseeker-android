...
public class VideoFragment1 extends Fragment {
    ...
    public static final VideoFragment1 newInstance(Video video, int artistId) {
    	VideoFragment1 videoFragment = new VideoFragment1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	View v = inflater.inflate(R.layout.fragment_video1, null);
    	...
    	v.setOnClickListener(new OnClickListener() {
    		...
    		public void onClick(View v) {
				 ...
				 */
				GoogleAnalyticsTracker.getInstance().sendEvent(FragmentUtil.getApplication(VideoFragment1.this), 
					FragmentUtil.getScreenName(VideoFragment1.this), GoogleAnalyticsTracker.ARTIST_VIDEO_CLICK,
