...
public abstract class FbPublishEventFragment extends Fragment implements FbPublishListener {
	
	private static final String TAG = FbPublishEventFragment.class.getSimpleName();
