...
public class MainActivityAL implements IProxyListenerALM {
	...
	public enum CmdId {
		MY_EVENTS(AppLinkService.START_CMD_ID_MAIN_ACTIVITY_AL),
		DISCOVER(AppLinkService.START_CMD_ID_MAIN_ACTIVITY_AL + 1),
		SEARCH(AppLinkService.START_CMD_ID_MAIN_ACTIVITY_AL + 2);
	...
	public void onOnCommand(OnCommand notification) {
		...
		case MY_EVENTS:
			...
			AppLinkService.getInstance().setIProxyListenerALM(myEventsActivityAL);
