...
public class LoadMyEventsNewUI extends AsyncTask<Void, Void, List<Event>> {
	
	private static final int EVENTS_LIMIT = 10;

	private static final String TAG = LoadMyEventsNewUI.class.getSimpleName();
	...
	//For new UI
	public LoadMyEventsNewUI(String oauthToken, List<Event> eventList, DateWiseEventParentAdapterListener 
	...
	public LoadMyEventsNewUI(String oauthToken, List<Event> eventList, DateWiseEventParentAdapterListener dateWiseEventParentAdapterListener, 
