...
public abstract class FbGPlusRegisterFragment extends FragmentLoadableFromBackStack implements ConnectionCallbacks, 
    ...
    protected void onFbClicked() {
    	ConnectionFailureListener connectionFailureListener = ((ConnectionFailureListener) 
				FragmentUtil.getActivity(FbGPlusRegisterFragment.this));
		if (!NetworkUtil.getConnectivityStatus((Context) connectionFailureListener)) {
			connectionFailureListener.onConnectionFailure();
			return;
		}
		FbUtil.onClickLogin(FbGPlusRegisterFragment.this, statusCallback);
    }
