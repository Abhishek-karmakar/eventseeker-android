...
public class BoschMainActivityOldVersion extends ActionBarActivity implements BoschDrawerListFragmentListener, 
		FragmentLoadedFromBackstackListener, ReplaceFragmentListener, GeoUtilListener {

	private static final String TAG = BoschMainActivityOldVersion.class.getSimpleName();
	...
	public void onFragmentResumed(Fragment fragment) {
		Log.d(TAG, "onFragmentResumed(Fragment fragment)");
