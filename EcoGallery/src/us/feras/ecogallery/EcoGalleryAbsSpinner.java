...
public abstract class EcoGalleryAbsSpinner extends EcoGalleryAdapterView<SpinnerAdapter> {
	...
	private android.view.ViewGroup.LayoutParams mChildLayoutParams;
        ...
        if (selectedPosition >= 0 && mAdapter != null) {
            ...
            if (view != null) {
                if (view.getLayoutParams() == null) {
                    ...
                    view.setLayoutParams(getChildLayoutParams());
	...
	protected void setChildLayoutParams(android.view.ViewGroup.LayoutParams lp) {
		mChildLayoutParams = lp;
	}
	
	protected android.view.ViewGroup.LayoutParams getChildLayoutParams() {
