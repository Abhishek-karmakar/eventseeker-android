...
public class EcoGallery extends EcoGalleryAbsSpinner implements
	...
	public EcoGallery(Context context, AttributeSet attrs, int defStyle) {
		...
		int childWidth = a.getDimensionPixelOffset(R.styleable.EcoGallery_childWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
		setSpacing(spacing);

		int childHeight = a.getDimensionPixelOffset(R.styleable.EcoGallery_childHeight, ViewGroup.LayoutParams.WRAP_CONTENT);
		setSpacing(spacing);

		super.setChildLayoutParams(new LayoutParams(childWidth, childHeight));
	...
	private void setUpChild(View child, int offset, int x, boolean fromLeft) {
		...
		if (lp == null) {
			lp = (LayoutParams) getChildLayoutParams();// (LayoutParams)
